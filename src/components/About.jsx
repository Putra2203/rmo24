...
const About = () => {
  return (
    <Section id="about" className="">
      ...
      <div className="max-w-[23rem] mx-auto md:max-w-5xl xl:mb-15">
        <div className="flex flex-col items-center justify-center gap-10 lg:flex-row">
          ...
          <div className="py-4 md:mx-6 lg:text-justify">
            ...
            <p className="text-sm text-n-2">
              ...
              unggul, menjalin kekerabatan antar mahasiswa kedokteran Indonesia
              di Wilayah 3, meningkatkan wawasan, pengetahuan serta jiwa
              kompetitif mahasiswa kedokteran Indonesia.
            </p>
          </div>
        </div>
      </div>
